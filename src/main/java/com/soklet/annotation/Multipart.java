...
/**
 * Apply to <em>Resource Method</em> parameters to enable HTML multipart form parameter injection.
 * <p>
...
public @interface Multipart {
	 ...
	 *
	 * @return the name of the HTML multipart form parameter to inject into this <em>Resource Method</em> parameter
	 */
	@Nullable
	String name() default "";

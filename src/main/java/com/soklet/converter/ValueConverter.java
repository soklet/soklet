 ...
 * <p>
 * Generic type inference follows parameterized superclasses and interfaces,
 * including intermediate generic base classes. A concrete converter must still
 * resolve both {@code F} and {@code T}; unresolved runtime type variables cause
 * construction to fail with an {@link IllegalStateException}.
 * <p>

...
test('fixture configuration only permits the three explicit causal cases and disposable token shape', async () => {
...
test('OAuth discovery and registration stop locally with fixed path enums, even without credentials', async () => {

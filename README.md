...
If you don't use Maven or Gradle, you can drop [soklet-2.1.3.jar](https://repo1.maven.org/maven2/com/soklet/soklet/2.1.3/soklet-2.1.3.jar) directly into your project. No other dependencies are required.

### Code Sample

Here we demonstrate building and running a single-file Soklet application with nothing but the [soklet-2.1.3.jar](https://repo1.maven.org/maven2/com/soklet/soklet/2.1.3/soklet-2.1.3.jar) and the JDK. There are no other libraries or frameworks, no Servlet container, no Maven or Gradle build process - no special setup is required.
